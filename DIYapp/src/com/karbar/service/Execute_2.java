...
public class Execute_2 extends Service {
	...
	public void createLocations(Location l){
		location = l;
		
		String data = "Position from l: " + l.getLatitude() + " , " + l.getLongitude() +" on time " + l.getTime();
		
		Toast.makeText(this, "My location changed " + l.getLatitude() + " , " + l.getLongitude(), Toast.LENGTH_LONG).show();
		writeToFile(data);
	}
	
	private void writeToFile(String data) {
	    try{
		    File newFolder = new File(Environment.getExternalStorageDirectory(), "LocationsLog");
		    if (!newFolder.exists()) {
		        newFolder.mkdir();
		    }
		    

		        File file = new File(newFolder, "LocationLog" + ".txt");
		        if(!file.exists())
		        	file.createNewFile();
			    ...
			    Toast.makeText(this, "Writting file "+ file.getAbsolutePath(), Toast.LENGTH_LONG).show();
		    	Log.d("am_service", "Writting file "+ file.getAbsolutePath());
	    	...
	    	Toast.makeText(this, "Exception in file: " + e.toString(), Toast.LENGTH_LONG).show();
	    	Log.d("am_service", "Exception in file: " + e.toString());
	...
	public void onCreate() {
		Toast.makeText(this, "My Service 2 Created", Toast.LENGTH_LONG).show();
		Log.d("am_service", "Service 2 created");
		...
		locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 90 * 100, 300, locationListener); //co 90 sekund lub co 300 metrow
		/**
	...
	public void onStart(Intent intent, int startid) {
		Toast.makeText(this, "My Service 2 Started", Toast.LENGTH_LONG).show();
		Log.d("am_service", "Service 2 started");
		Log.d("kkams", "onStart");
		writeToFile("okresowe wykonywanie\n");
		okresowewykonywanie();
	}
	...
	private void okresowewykonywanie() {
				...
				Log.d("am_service", "Service 2 Ala1");
		...
		if (groupsWithAddedConditions != null
			...
			for (HashMap<String, String> AddedCondition : groupsWithAddedConditions) {
				...
				case (int) Constant.CONDITION_GPS:
					...
					boolean czy2 = tr.sprawdzGPS(id_add_con, params, location);
					retArray.add(czy2);
					break;
